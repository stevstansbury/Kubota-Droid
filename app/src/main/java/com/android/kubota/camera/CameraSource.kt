...
class CameraSource(private var activity: Activity, private val graphicOverlay: GraphicOverlay) {
    ...
    fun start(): CameraSource {
        ...
        Log.d(TAG, "1. Created new Camera")
        camera = createCamera()
    ...
    fun start(surfaceHolder: SurfaceHolder): CameraSource {
        ...
        Log.d(TAG, "2. Created new Camera")
        camera = createCamera()
    ...
    fun stop() {
        ...
        Log.d(TAG, "stop. ProcessingThread is null? ${processingThread != null}")
    ...
    class SizePair {
        ...
        internal constructor(previewSize: Camera.Size, pictureSize: Camera.Size?) {
            ...
            picture =
                if (pictureSize != null) Size(pictureSize.width, pictureSize.height) else null
        }
    ...
    private fun createPreviewBuffer(previewSize: Size): ByteArray {
        ...
        val sizeInBits = previewSize.getHeight().toLong() * previewSize.getWidth() * bitsPerPixel
    ...
    companion object {
        ...
        private const val TAG = "myKubota:CameraSource"
        ...
        private fun generateValidPreviewSizeList(camera: Camera): List<SizePair> {
            ...
            val supportedPictureSizes = parameters.getSupportedPictureSizes()
            val validPreviewSizes = mutableListOf<SizePair>()
        ...
        private fun selectPreviewFpsRange(camera: Camera, desiredPreviewFps: Float): IntArray? {
            ...
            var minDiff = Integer.MAX_VALUE
            val previewFpsRangeList = camera.getParameters().getSupportedPreviewFpsRange()
