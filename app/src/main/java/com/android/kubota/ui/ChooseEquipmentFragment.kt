...
private class CategoryListAdapter(
    ...
    override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup?): View {
        ...
        groupView.findViewById<ImageView>(R.id.chevronImageView)
            .setImageResource(if (isExpanded) R.drawable.ic_chevron_up else R.drawable.ic_chevron_down)
    ...
    override fun getChildView(
        ...
        val resId = CategoryUtils.getEquipmentImage(group, child)
            ...
            if (!isSelectedChildView(groupPosition, childPosition)) {
                ...
                onItemSelected(
                    EquipmentUIModel(
                        id = 1,
                        name = child,
                        equipmentCategory = CategoryUtils.CATEGORY_MAP[getGroup(groupPosition)]!!,
                        imageResId = resId
                    )
                )
